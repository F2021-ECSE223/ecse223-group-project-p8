...
public class NMC
{
  ...
  /* Code from template association_AddManyToOne */
  public Bundle addBundle(double aPercentageDiscount, int aCost, String aName)
  {
    return new Bundle(aPercentageDiscount, aCost, aName, this);
  }
