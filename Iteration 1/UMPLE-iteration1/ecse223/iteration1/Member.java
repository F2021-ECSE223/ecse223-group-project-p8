...
public class Member extends Registrant
{
  ...
  public Member(String aEmailAddress, String aPassword, String aName, int aEmergencyContact, boolean aHireGuide, int aNumberOfWeeks, boolean aHotelStay)
  {
