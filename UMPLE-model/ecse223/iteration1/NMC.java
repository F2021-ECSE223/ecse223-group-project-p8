...
public class NMC
{
  ...
  /* Code from template association_AddManyToOne */
  public Hotel addHotel(String aName, String aAddress, Hotel.StarRating aStarRating)
  {
    return new Hotel(aName, aAddress, aStarRating, this);
  }
  ...
  /* Code from template association_AddManyToOne */
  public Equipment addEquipment(int aPricePerWeek, double aWeight)
  {
    return new Equipment(aPricePerWeek, aWeight, this);
  }
  ...
  /* Code from template association_AddManyToOne */
  public MountainGuide addMountainGuide(String aName, int aEmergencyContact, int aWeeklyCost)
  {
    return new MountainGuide(aName, aEmergencyContact, aWeeklyCost, this);
  }
  ...
  /* Code from template association_AddManyToOne */
  public Bundle addBundle(double aPercentageDiscount, int aCost, String aName, Equipment... allEquipmentInBundle)
  {
    return new Bundle(aPercentageDiscount, aCost, aName, this, allEquipmentInBundle);
  }
