...
public class equipmentBundlePageController {
	...
	@FXML
	public String getBundleName(InputMethodEvent event) {
		String bundleName = bundleNameInput.getText();
		return bundleName;
	}
	...
	// Event Listener on
	// TextField[#equipmentQuanityInputCB].onInputMethodTextChanged
	@FXML
	...
	// Event Listener on
	// TextField[#equipmentQuanityInputEB].onInputMethodTextChanged
	@FXML
